...
struct EntryEditView: View {
    ...
    let existingId: UUID?
    let onSave: (PaymentEntry) -> Void

    init(entry: PaymentEntry?, onSave: @escaping (PaymentEntry) -> Void) {
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle(existingId == nil ? "Add Payment" : "Edit Payment")
            .toolbar {
